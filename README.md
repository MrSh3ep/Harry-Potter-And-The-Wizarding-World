...
- **Every** thing you read in the Harry Potter book series **is planned!** Right now we are in the **beta stage** meanining, spells and items are being addded and bugs are being fixed. **The goal for release one is as follows:**
  ...
  1. **At least 10 spells.** _(most likely more than 10)_
  2. An i**mproved crafting** system
  3. An immersive **settings menu**, that becomes a floating GUI infront of the player
  4. A **field guide,** giving acsess to quests, recipies etc..
  5. **Full survival compatibility**
...
![main_wand_showcase](https://www.dropbox.com/scl/fi/4mpoui4wn2y5lqqcawjub/main_wand_showcase.png?rlkey=lq4qf6qsncdvi4sl1il34l5hm&st=s8gnyxhp&dl=1)
