$data modify storage hpww:cooldown_api args set value {spell:"$(spell)",selected:$(selected)}
scoreboard players set @s cooldown_api_active 1

scoreboard players set #selected_arg cooldown_api 0
execute store result score #selected_arg cooldown_api run data get storage hpww:cooldown_api args.selected 1
...
$execute if score #selected_arg cooldown_api matches 1.. run data modify storage hpww:cooldown_api icon set value {spell:"$(spell)",key_path:"Keys.Selected"}
execute if score #selected_arg cooldown_api matches 1.. run function hpww:main/spells/function/api/spell_cooldown/icons/apply_icon_to_storage with storage hpww:cooldown_api icon
execute if score #selected_arg cooldown_api matches 1.. run scoreboard players set #cooldown_icon_changed cooldown_api 1
$execute unless score #selected_arg cooldown_api matches 1.. run function hpww:main/spells/function/api/spell_cooldown/icons/refresh_spell_icon_loaded {spell:"$(spell)"}
...
execute if score #cooldown_icon_changed cooldown_api matches 1.. if score @s SpellWheelStatus matches 1 run function hpww:main/spellwheel/wheel/function/display/start
