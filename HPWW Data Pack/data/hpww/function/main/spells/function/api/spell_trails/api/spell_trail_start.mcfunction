...
$summon armor_stand ^ ^ ^ {Tags:[spell_trail, protego_blockable, needs_rotation, trail_color_$(color)], Small:1b, Invisible:1b, attributes:[{id:"gravity", base:0.0000000000000000001}]}
