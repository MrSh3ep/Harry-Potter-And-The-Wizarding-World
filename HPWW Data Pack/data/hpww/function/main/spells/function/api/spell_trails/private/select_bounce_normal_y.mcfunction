scoreboard players operation #normal_abs spell_trail_motion = #abs_vy spell_trail_motion
...
execute if score #vy spell_trail_motion matches 1.. run scoreboard players set #ny spell_trail_motion -1
execute if score #vy spell_trail_motion matches ..-1 run scoreboard players set #ny spell_trail_motion 1
