...
$execute if score #selected cooldown_api matches 1.. run data modify storage hpww:cooldown_api icon set value {spell:"$(spell)",key_path:"Keys.Selected"}
execute if score #selected cooldown_api matches 1.. run function hpww:main/spells/function/api/spell_cooldown/icons/apply_icon_to_storage with storage hpww:cooldown_api icon
