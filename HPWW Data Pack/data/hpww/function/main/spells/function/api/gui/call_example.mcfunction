execute as @s run function hpww:main/spells/function/api/gui/begin
execute as @s run function hpww:main/spells/function/api/gui/define_slot {font:"hpww:item_wheel", character:"\ue002", pos_x:"15", pos_y:"08", align:"0", size:"6"}
execute as @s run function hpww:main/spells/function/api/gui/define_slot {font:"hpww:item_wheel", character:"\ue001", pos_x:"15", pos_y:"09", align:"0", size:"6"}
execute as @s run function hpww:main/spells/function/api/gui/draw
