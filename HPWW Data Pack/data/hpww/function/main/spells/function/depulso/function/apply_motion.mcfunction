...
execute if entity @s[type=player] run function hpww:main/spells/function/depulso/function/motion_player
execute unless entity @s[type=player] run function hpww:main/spells/function/depulso/function/motion_entity
