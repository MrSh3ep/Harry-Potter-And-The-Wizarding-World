...
execute if entity @s[type=player] run function hpww:main/spells/function/basic_cast/apply_hit_motion_player
execute unless entity @s[type=player] run function hpww:main/spells/function/basic_cast/apply_hit_motion_entity
