...
$data modify storage pdb:main in.spell_wheel_data.spells.page_$(Page).slot_$(Slot) set from storage hpww:gobal_spell_data $(Spell)
...
execute as @s run advancement revoke @s only hpww:blocks/main_wand/right_click_exit_wheel_button
