...
data remove storage hpww:expelliarmus_disarm pickup_item
data modify storage hpww:expelliarmus_disarm pickup_item set from entity @n[type=item_display,tag=expelliarmus_disarmed_wand,tag=expelliarmus_wand_landed,distance=..3] item
...
execute at @s run data modify entity @n[type=item,tag=expelliarmus_new_return_item,distance=..1.2] Item set from storage hpww:expelliarmus_disarm pickup_item
