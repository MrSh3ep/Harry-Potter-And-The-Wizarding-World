execute if score @s levioso_spell_active.timer matches 1.. run advancement revoke @s only hpww:blocks/main_wand/right_click_main_wand
...
execute if score @s SettingsMenuStatus matches 1 run advancement revoke @s only hpww:blocks/main_wand/right_click_main_wand
...
function pdb:get_me_cached
execute if score @s HasPreset matches 0 run return run function hpww:main/spellwheel/wheel/function/first_open with storage pdb:main out.wands.first_open.data

function hpww:main/spellwheel/wheel/function/cache/refresh_if_dirty

function pdb:get_me_cached
function hpww:main/spellwheel/wheel/function/give_wands_main
