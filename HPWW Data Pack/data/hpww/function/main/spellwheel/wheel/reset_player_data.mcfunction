...
execute as @s run advancement grant @s only hpww:blocks/main_wand/right_click_exit_wheel_button
execute as @s run advancement revoke @s only hpww:blocks/main_wand/right_click_main_wand
