playsound ui.button.click master @s ~ ~ ~ 0.2
 ...
 scoreboard players remove @s hpww.fg.spell_wheel_page.drawer_page 1

execute if score @s hpww.fg.spell_wheel_page.drawer_page matches 0 run scoreboard players set @s hpww.fg.spell_wheel_page.drawer_page 10
