...
#set indicator highlight
    ...
    function hpww:main/spells/function/api/uuid_selector/api/as_at_linked_entities {entities:"@e[type=item_display, tag=aj.fg_spell_wheel.bone.other_5, limit=1, sort=nearest, distance=0..5]", function:"aj:fg_spell_wheel/variants/drawer_indicator_other_5_off/apply"}
...
#Slot 1
    ...
    execute as @e[tag=aj.fg_spell_wheel.interaction.drawer_slot_1_interaction, distance=0..5, limit=1, sort=nearest, type=interaction] run function hpww:main/field_guide/gui/spell_wheel_page/bind/set_drawer_spell {spell_name:"expelliarmus"}
