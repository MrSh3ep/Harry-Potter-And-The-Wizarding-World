...
#Slot 1
    ...
    execute as @e[tag=aj.fg_spell_wheel.interaction.drawer_slot_1_interaction, distance=0..5, limit=1, sort=nearest, type=interaction] run function hpww:main/field_guide/gui/spell_wheel_page/bind/set_drawer_spell {spell_name:"lumos"}
