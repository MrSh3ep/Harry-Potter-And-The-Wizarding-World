...
execute at @s run function aj:hpww_trial_start_button/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:hpww_trial_start_button/animations/idle/zzz/apply_frame {frame: $(to_frame)}
