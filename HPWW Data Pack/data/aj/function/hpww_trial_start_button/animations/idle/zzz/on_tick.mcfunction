...
execute if score @s aj.idle.frame matches -1 run function aj:hpww_trial_start_button/animations/idle/zzz/function_keyframe_loop_patch
data remove storage animated_java:temp args
execute store result storage animated_java:temp args.frame int 1 run scoreboard players get @s aj.idle.frame
function aj:hpww_trial_start_button/animations/idle/zzz/apply_frame with storage animated_java:temp args
