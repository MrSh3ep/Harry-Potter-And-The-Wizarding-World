...
# To add a cooldown spell: add its definition here, then add one line in tick/registry.mcfunction and icons/force_refresh_all_icons.mcfunction.
...
data modify storage pack:gobal_spell_data cooldown_registry set value ["lumos","levioso","protego"]
