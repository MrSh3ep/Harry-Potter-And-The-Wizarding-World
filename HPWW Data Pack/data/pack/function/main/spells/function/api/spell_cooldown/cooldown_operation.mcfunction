$data modify storage pack:cooldown_api args set value {spell:"$(spell)",operation:"$(operation)",value:$(value)}
...
execute store result score #scaled cooldown_api run data get storage pack:cooldown_api args.value 1000
...
execute if data storage pack:cooldown_api args{operation:"addition"} run scoreboard players operation #remaining cooldown_api += #ticks cooldown_api
execute if data storage pack:cooldown_api args{operation:"subtraction"} run scoreboard players operation #remaining cooldown_api -= #ticks cooldown_api
