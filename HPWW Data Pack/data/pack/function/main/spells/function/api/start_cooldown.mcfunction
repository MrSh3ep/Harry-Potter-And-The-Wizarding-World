$data modify storage pack:cooldown_api args set value {spell:"$(spell)",time:$(time)}
...
execute store result score #scaled cooldown_api run data get storage pack:cooldown_api args.time 1000
