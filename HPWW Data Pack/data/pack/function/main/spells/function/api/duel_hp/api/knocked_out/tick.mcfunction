execute if score @s current_duel_hp matches ..0 run function pack:main/spells/function/api/duel_hp/api/knocked_out/knocked_out_03
...
execute if score @s knocked_out_timer matches 0 run function pack:main/spells/function/api/duel_hp/api/knocked_out/tick_line_13
