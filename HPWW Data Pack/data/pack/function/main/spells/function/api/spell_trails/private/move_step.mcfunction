...
execute if score #step_speed spell_trail_motion <= #half_step spell_trail_motion positioned ^ ^ ^0.05 run function pack:main/spells/function/api/spell_trails/private/check_collision_at_context
execute if score #step_speed spell_trail_motion > #half_step spell_trail_motion positioned ^ ^ ^0.1 run function pack:main/spells/function/api/spell_trails/private/check_collision_at_context
...
execute unless score #normal_found spell_trail_motion matches 1 unless score #step_speed spell_trail_motion = #max_step spell_trail_motion at @s run function pack:main/spells/function/api/spell_trails/private/move_step_apply
