scoreboard players set @s new_player_storage 1
...
function pack:main/spells/function/api/spell_trails/private/storage/zprivate/new_player with storage pack:trail_storage args
