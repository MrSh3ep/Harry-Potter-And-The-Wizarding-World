...
function pack:main/spells/function/api/spell_trails/api/spell_trail_start {end_function_namespace:"pack",end_function:"main/spells/function/basic_cast/basic_cast_damage", color_1:[1.0,0.22,0.22], color_2:[1.0,0.45,0.22], speed:2200, life_ticks:30, color:"red"}
