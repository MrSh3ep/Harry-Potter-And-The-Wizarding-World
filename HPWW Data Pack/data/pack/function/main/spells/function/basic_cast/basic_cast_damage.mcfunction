...
execute as @n[type=!#pack:nonlevioso, distance=0.1..1.4] at @s rotated as @n[type=armor_stand,tag=spell_trail,tag=trail_color_red,distance=0..2,limit=1,sort=nearest] run function pack:main/spells/function/basic_cast/apply_hit_motion
