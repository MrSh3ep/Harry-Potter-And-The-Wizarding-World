...
data remove storage pack:expelliarmus_disarm item
...
execute if score @s expelliarmus_wand_slot matches 0 if data entity @s Inventory[{Slot:0b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:0b}]
execute if score @s expelliarmus_wand_slot matches 1 if data entity @s Inventory[{Slot:1b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:1b}]
execute if score @s expelliarmus_wand_slot matches 2 if data entity @s Inventory[{Slot:2b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:2b}]
execute if score @s expelliarmus_wand_slot matches 3 if data entity @s Inventory[{Slot:3b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:3b}]
execute if score @s expelliarmus_wand_slot matches 4 if data entity @s Inventory[{Slot:4b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:4b}]
execute if score @s expelliarmus_wand_slot matches 5 if data entity @s Inventory[{Slot:5b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:5b}]
execute if score @s expelliarmus_wand_slot matches 6 if data entity @s Inventory[{Slot:6b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:6b}]
execute if score @s expelliarmus_wand_slot matches 7 if data entity @s Inventory[{Slot:7b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:7b}]
execute if score @s expelliarmus_wand_slot matches 8 if data entity @s Inventory[{Slot:8b,components:{"minecraft:custom_data":{wand:1b}}}] run data modify storage pack:expelliarmus_disarm item set from entity @s Inventory[{Slot:8b}]

execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 0 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.0
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 1 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.1
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 2 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.2
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 3 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.3
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 4 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.4
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 5 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.5
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 6 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.6
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 7 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.7
execute unless data storage pack:expelliarmus_disarm item if score @s SpellWheelStatus matches 1 if score @s expelliarmus_wand_slot matches 8 run data modify storage pack:expelliarmus_disarm item set from storage pdb:main out.hotbar.8

execute unless data storage pack:expelliarmus_disarm item run return fail
data remove storage pack:expelliarmus_disarm item.Slot

function pack:main/spells/function/expelliarmus/function/disarmed_wand/remove_saved_hotbar_slot
execute if score @s SpellWheelStatus matches 1 run function pack:main/spellwheel/wheel/function/close_wheel
