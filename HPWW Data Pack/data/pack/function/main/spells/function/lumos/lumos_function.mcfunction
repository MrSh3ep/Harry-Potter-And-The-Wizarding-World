...
execute as @s at @s if score @s lumos_activated matches 1 run return run function pack:main/spells/function/lumos/lumos_end

execute unless score @s lumos_cooldown matches 0 run return run function pack:main/spells/function/lumos/lumos_cooldown_sfx
