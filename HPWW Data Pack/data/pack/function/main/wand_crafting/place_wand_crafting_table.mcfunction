...
execute if entity @a[tag=pack.placed_item_frame,distance=..10,limit=1,sort=nearest,y_rotation=-180..-135] run data merge entity @n[type=item_display,tag=pack.new_wand_crafting_table_block,distance=..2] {Rotation:[0f,0f]}
execute if entity @a[tag=pack.placed_item_frame,distance=..10,limit=1,sort=nearest,y_rotation=-135..-45] run data merge entity @n[type=item_display,tag=pack.new_wand_crafting_table_block,distance=..2] {Rotation:[90f,0f]}
tag @n[type=item_display,tag=pack.new_wand_crafting_table_block,distance=..2] remove pack.new_wand_crafting_table_block
