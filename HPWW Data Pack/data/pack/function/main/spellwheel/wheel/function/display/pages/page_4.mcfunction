...
#split functions bc they are saving the true/false values maybe..
    #slot 1
     ...
     data modify storage pdb:main in.spell_wheel_draw.slot_1 set from storage pdb:main in.spell_wheel_data.spells.page_4.slot_1.Current_Key

     data modify storage pdb:main in.spell_wheel_draw.slot_2 set from storage pdb:main in.spell_wheel_data.spells.page_4.slot_2.Current_Key

     data modify storage pdb:main in.spell_wheel_draw.slot_3 set from storage pdb:main in.spell_wheel_data.spells.page_4.slot_3.Current_Key

     data modify storage pdb:main in.spell_wheel_draw.slot_4 set from storage pdb:main in.spell_wheel_data.spells.page_4.slot_4.Current_Key
