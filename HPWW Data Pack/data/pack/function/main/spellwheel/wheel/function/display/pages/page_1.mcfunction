...
#split functions bc they are saving the true/false values maybe..
    ...
    data modify storage pdb:main in.spell_wheel_draw_data.slot_3 set from storage pdb:main in.spell_wheel_data.spells.page_1.slot_3.Spell

    data modify storage pdb:main in.spell_wheel_draw_data.slot_4 set from storage pdb:main in.spell_wheel_data.spells.page_1.slot_4.Spell
