...
function pdb:get_me
data modify storage pdb:main out.give_item_components set from storage pdb:main out.preset.2
...
function pack:main/spellwheel/wheel/function/give_wands/h2/give with storage pdb:main out.give_item_components
