...
function pdb:get_me
data modify storage pdb:main out.give_item_components set from storage pdb:main out.preset.1
...
function pack:main/spellwheel/wheel/function/give_wands/h1/give with storage pdb:main out.give_item_components
