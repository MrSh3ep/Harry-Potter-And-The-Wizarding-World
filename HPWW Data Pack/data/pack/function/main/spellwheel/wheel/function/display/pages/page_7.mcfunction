# Draw page 7 from cached per-player storage.
data remove storage pack:spell_wheel_runtime draw
data modify storage pack:spell_wheel_runtime draw set from storage pdb:main out.spell_wheel_cache.page_7.draw
